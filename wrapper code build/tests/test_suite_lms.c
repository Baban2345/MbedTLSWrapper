 ...
 *      Test suite file     : /home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lms.function
 *      Test suite data     : /home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lms.data
 *
 */
...
#line 2 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lms.function"
#include "mbedtls/lms.h"

#if defined(MBEDTLS_LMS_PRIVATE)
#line 12 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lms.function"
void test_lms_sign_verify_test(data_t *msg, data_t *seed)
{
...
void test_lms_sign_verify_test_wrapper( void ** params )
{
...
#if defined(MBEDTLS_LMS_PRIVATE)
#line 45 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lms.function"
void test_lms_sign_verify_null_msg_test(data_t *seed)
{
    mbedtls_lms_public_t pub_ctx;
    mbedtls_lms_private_t priv_ctx;
    unsigned char sig[MBEDTLS_LMS_SIG_LEN(MBEDTLS_LMS_SHA256_M32_H10, MBEDTLS_LMOTS_SHA256_N32_W8)];
...
void test_lms_sign_verify_null_msg_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
...
#endif /* MBEDTLS_LMS_PRIVATE */
#line 78 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lms.function"
void test_lms_verify_test(data_t *msg, data_t *sig, data_t *pub_key,
                     int expected_rc)
{
...
void test_lms_verify_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
...
#line 146 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lms.function"
void test_lms_import_export_test(data_t *pub_key, int expected_import_rc)
{
    mbedtls_lms_public_t ctx;
...
void test_lms_import_export_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
