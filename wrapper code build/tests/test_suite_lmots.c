 ...
 *      Test suite file     : /home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function
 *      Test suite data     : /home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.data
 *
 */
...
#line 2 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function"
#include "lmots.h"
...
#line 31 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function"
void test_lmots_sign_verify_test(data_t *msg, data_t *key_id, int leaf_id,
                            data_t *seed)
{
...
void test_lmots_sign_verify_test_wrapper( void ** params )
{
...
#if defined(MBEDTLS_LMS_PRIVATE)
#line 55 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function"
void test_lmots_sign_verify_null_msg_test(data_t *key_id, int leaf_id, data_t *seed)
{
    mbedtls_lmots_public_t pub_ctx;
    mbedtls_lmots_private_t priv_ctx;
    unsigned char sig[MBEDTLS_LMOTS_SIG_LEN(MBEDTLS_LMOTS_SHA256_N32_W8)];
...
void test_lmots_sign_verify_null_msg_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
...
#endif /* MBEDTLS_LMS_PRIVATE */
#line 78 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function"
void test_lmots_verify_test(data_t *msg, data_t *sig, data_t *pub_key,
                       int expected_rc)
{
...
void test_lmots_verify_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
...
#line 144 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function"
void test_lmots_import_export_test(data_t *pub_key, int expected_import_rc)
{
    mbedtls_lmots_public_t ctx;
...
void test_lmots_import_export_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
...
#if defined(MBEDTLS_LMS_PRIVATE)
#line 199 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function"
void test_lmots_reuse_test(data_t *msg, data_t *key_id, int leaf_id, data_t *seed)
{
...
void test_lmots_reuse_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
...
#if defined(MBEDTLS_TEST_HOOKS)
#if defined(MBEDTLS_LMS_PRIVATE)
#line 224 "/home/vboxuser/Documents/mbedtls-development/tests/suites/test_suite_lmots.function"
void test_lmots_signature_leak_test(data_t *msg, data_t *key_id, int leaf_id,
                               data_t *seed)
{
    mbedtls_lmots_private_t ctx;
    unsigned char sig[MBEDTLS_LMOTS_SIG_LEN(MBEDTLS_LMOTS_SHA256_N32_W8)];
...
void test_lmots_signature_leak_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
